...
public class DelayedMqConfig {
    ...
    public static final String exchange_delay = "exchange.delay1";
    public static final String routing_delay = "routing.delay1";
    public static final String queue_delay_1 = "queue.delay.11";
